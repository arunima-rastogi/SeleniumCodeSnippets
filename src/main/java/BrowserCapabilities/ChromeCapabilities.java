...
public class ChromeCapabilities extends BaseCapabilities {
	...
	public ChromeCapabilities(DesiredCapabilities customCaps, UnexpectedAlertBehaviour alertBehaviour, boolean isHeadless,
			Platform platform) {
		super(customCaps);
	...
	public ChromeOptions get() {
		...
		if (!this.customCaps.asMap().isEmpty()) {
			...
			// This is a workaround for ChromeOptions.merge() issue when passed arguments
			// are not being assigned properly
			Map<String, Object> chromeCapability = (Map<String, Object>) chromeOptions
