 ...
 */
public class FirefoxCapabilities extends BaseCapabilities {

    private final UnexpectedAlertBehaviour alertBehaviour;
    private final Platform platform;

    public FirefoxCapabilities(DesiredCapabilities customCaps, UnexpectedAlertBehaviour alertBehaviour, Platform platform) {
        super(customCaps);
