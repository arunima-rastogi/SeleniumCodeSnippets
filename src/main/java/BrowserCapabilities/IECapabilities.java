 ...
 * Caps for IE driver
 */
public class IECapabilities extends BaseCapabilities {

    private final UnexpectedAlertBehaviour alertBehaviour;
    private final String version;

    public IECapabilities(DesiredCapabilities customCaps, String version, UnexpectedAlertBehaviour alertBehaviour) {
        super(customCaps);
