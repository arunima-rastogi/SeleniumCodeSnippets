...
public class ClientConfiguration {
	...
	public final static void main(String[] args) throws Exception {
		...
		CloseableHttpClient httpclient = HttpClients.custom().setConnectionManager(connManager)
				...
				.setProxy(new HttpHost("rdc-proxy.allstate.com", 8080)).setDefaultRequestConfig(defaultRequestConfig).build();
		...
		try {
			...
			RequestConfig requestConfig = RequestConfig.copy(defaultRequestConfig).setSocketTimeout(5000)
					...
					.setProxy(new HttpHost("rdc-proxy.allstate.com", 8080)).build();
